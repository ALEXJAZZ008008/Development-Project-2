...
namespace API
{
    class Test
    {
        static void Main(string[] args)
        {
            ...
            Scenario scenarioZero = new Scenario(new List<Choice>(), directoryPath + "/Scenarios/Assets/Videos/Stationary1.mp4", directoryPath + "/Scenarios/Assets/Audio/AmbientHospital.wav", directoryPath + "/Scenarios/Assets/Audio/Narration.wav", directoryPath + "/Scenarios/Assets/Audio/AlarmSound.wav", directoryPath + "/Scenarios/Assets/Output", "scenarioText0", "scenarioChoiceText0", 3.0f, 1.0f, 0.25f, 0.75f, 1.0f, 0.5f, 10.0f, false, false, false, false, false);
            Scenario scenarioOne = new Scenario(new List<Choice>(), directoryPath + "/Scenarios/Assets/Videos/Stationary2.mp4", directoryPath + "/Scenarios/Assets/Audio/AmbientRadio.wav", string.Empty, directoryPath + "/Scenarios/Assets/Audio/AlarmSound.wav", string.Empty, "scenarioText1", "scenarioChoiceText1", 3.0f, 0.9f, 0.25f, 0.3f, 0.0f, 0.5f, 9.0f, true, false, false, false, false);
            Scenario scenarioTwo = new Scenario(new List<Choice>(), directoryPath + "/Scenarios/Assets/Videos/Stationary3.mp4", directoryPath + "/Scenarios/Assets/Audio/AmbientHospital.wav", directoryPath + "/Scenarios/Assets/Audio/Narration.wav", directoryPath + "/Scenarios/Assets/Audio/AlarmSound.wav", string.Empty, "scenarioText2", "scenarioChoiceText2", 3.0f, 0.8f, 0.25f, 0.75f, 1.0f, 0.5f, 8.0f, true, true, false, false, false);
            Scenario scenarioThree = new Scenario(new List<Choice>(), directoryPath + "/Scenarios/Assets/Videos/Stationary4.mp4", directoryPath + "/Scenarios/Assets/Audio/AmbientRadio.wav", string.Empty, directoryPath + "/Scenarios/Assets/Audio/AlarmSound.wav", string.Empty, "scenarioText3", "scenarioChoiceText3", 3.0f, 0.7f, 0.25f, 0.3f, 0.0f, 0.5f, 7.0f, true, true, false, true, true);
            Scenario scenarioFour = new Scenario(new List<Choice>(), directoryPath + "/Scenarios/Assets/Videos/Trolly1.mp4", directoryPath + "/Scenarios/Assets/Audio/AmbientHospital.wav", directoryPath + "/Scenarios/Assets/Audio/Narration.wav", directoryPath + "/Scenarios/Assets/Audio/AlarmSound.wav", string.Empty, "scenarioText4", "scenarioChoiceText4", 3.0f, 0.6f, 0.25f, 0.75f, 1.0f, 0.5f, 6.0f, true, true, true, true, true);
            Scenario scenarioFive = new Scenario(new List<Choice>(), directoryPath + "/Scenarios/Assets/Videos/Walking1.mp4", directoryPath + "/Scenarios/Assets/Audio/AmbientRadio.wav", string.Empty, directoryPath + "/Scenarios/Assets/Audio/AlarmSound.wav", string.Empty, "scenarioText5", "scenarioChoiceText5", 3.0f, 0.5f, 0.25f, 0.3f, 1.0f, 0.5f, 5.0f, false, false, false, false, false);
            Scenario scenarioSix = new Scenario(new List<Choice>(), string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, "scenarioText6", "scenarioChoiceText6", 3.0f, 0.4f, 0.25f, 0.75f, 1.0f, 0.75f, 4.0f, false, false, false, false, false);
